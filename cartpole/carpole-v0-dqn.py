...
class DQN(nn.Module):
    ...
    def __init__(self, h, w):
        ...
        self.conv1 = nn.Conv2d(3, 16, kernel_size=5, stride=2) # conv layer in_channels = 3 and out_channels = 16 
...
def optimize_model():
    ...
    # Expected values of actiplt.ioff()ons for non_final_next_states are computed based
